  ...
  return (
    ...
    >
      ...
      >
        ...
        {!device && (
          <Text style={styles.muted}>Checking payment options...</Text>
        )}
        ...
        {canUse('google_pay') && (
          ...
          >
            <Text style={[styles.methodText, styles.googlePayText]}>
              Google Pay
            </Text>
          </Pressable>
        )}
        ...
        {canUse('card') && (
          <Pressable
            style={[styles.method, busy && styles.methodDisabled]}
            disabled={busy}
